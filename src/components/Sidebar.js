            ...
            <div className='flex flex-col space-y-1'>
                ...
                <div className={`flex items-center rounded-md w-64 h-12 md:w-auto lg:w-64  duration-300 cursor-pointer ${
                    selected === 3 ? 'bg-color7' : ''}`}
                      onClick={() => {handleItemClick(3); navigate('/employees')}}
                    >
                    <div className='flex items-center ml-4 space-x-3'>
                      <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center rounded-md w-64 h-12 md:w-auto lg:w-64 duration-300 cursor-pointer"
                    ...
                    <div className='flex items-center ml-4 space-x-3'>
                      <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h2 className="text-sm font-face-m font-medium lg:block md:hidden text-color18 "
                          >Financial Overview
                        </h2>
                    </div>
                </div>
                ...
                <div className="flex items-center rounded-md w-64 h-12 md:w-auto lg:w-64 duration-300 cursor-pointer">
                  <div className='flex items-center ml-4 space-x-3'>
                    <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h2 className="text-sm font-face-m font-medium  md:hidden lg:block text-color18 cursor-pointer"
                    >Project Reporting
                      </h2>
                  </div>
                </div>
