               ...
               <div className='border w-1050  h-309  flex-col justify-center rounded-md'>
                  <div  className='flex-col space-y-5 ml-5 justify-center'>	
                     ...
                     <div className='space-y-0.5 '>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           ...
                           <span className='text-xl font-face-gsb font-semibold h-6 w-157 text-color10'>2,400,000.00 KM</span>
                        </div>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           <span className='text-xl font-face-r font-normal  w-63 text-color10'>Design</span>
                           <span className='text-xl font-face-gsb font-semibold h-6 w-153 text-color10'>7,800,000.00 KM</span>
                        </div>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           <span className='text-xl font-face-r font-normal  w-53 text-color10'>Other</span>
                           <span className='text-xl font-face-gsb font-semibold h-6 w-167 text-color10'>45,900,000.00 KM</span>
                        </div>
                        <div className='flex w-1009 h-10 justify-between items-center'>
                  ...
                  <div className='w-1049 mt-1 bg-color7'>
                     <div className='flex h-10  px-5 h-49 justify-between items-center'>
                        ...
                        <span className='text-xl font-face-b font-bold h-6 w-167 text-customColor'>91,800,000.00 KM</span>
                     </div>
                  </div>
               </div>     
         </div>   
               ...
               <div  className='flex-col space-y-7 ml-5 justify-center'>	
                  ...
                  <div className='space-y-0.5 '>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        ...
                        <span className='text-xl font-face-gsb font-semibold h-6 w-158 text-color10'>4,400,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-69 text-color10'>Indirect</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-154 text-color10'>1,400,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-91 text-color10'>Marketing</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-158 text-color10'>8,400,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-79 text-color10'>HR costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-141 text-color10'>400,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10  justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-99 text-color10'>Office cost</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-137 text-color10'>100,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-102 text-color10'>Sales costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-128 text-color10'>50,000.00 KM</span>
                     </div>
                     <div className='flex w-1009 h-10  justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-106 text-color10'>Other costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-99 text-color10'>800.00 KM</span>
                     </div>
                  </div>	    
               </div>
