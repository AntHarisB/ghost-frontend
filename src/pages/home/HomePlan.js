                  ...
                  <div  className='flex-col space-y-5 ml-5 justify-center'>	
                     ...
                     <div className='space-y-0.5 '>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           ...
                           <span className='text-xl font-face-gsb font-semibold h-6 w-157 text-color10 text-end'>{planData[0]?.dev_total ? planData[0].dev_total.toLocaleString() : ''} KM</span>
                        </div>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           <span className='text-xl font-face-r font-normal  w-63 text-color10'>Design</span>
                           <span className='text-xl font-face-gsb font-semibold h-6 w-153 text-color10 text-end'>{planData[0]?.design_total ? planData[0].design_total.toLocaleString() : ''} KM</span>
                        </div>
                        <div className='flex w-1009 h-10  justify-between items-center'>
                           <span className='text-xl font-face-r font-normal  w-53 text-color10'>Other</span>
                           <span className='text-xl font-face-gsb font-semibold h-6 w-167 text-color10 text-end'>{planData[0]?.other_total ? planData[0].other_total.toLocaleString() : ''} KM</span>
                        </div>
                        <div className='flex w-1009 h-10 justify-between items-center'>
                           <span className='text-xl font-face-r font-normal  w-123 text-color10'>Total revenue</span>
                           <span className='text-xl font-face-gsb font-semibold h-6 w-157 text-color10 text-end'>{planData[0]?.total_rev_total ? planData[0].total_rev_total.toLocaleString() : ''} KM</span>
                        </div>  
                     </div>	
                  </div>
               ...
               <div  className='flex-col space-y-7 ml-5 justify-center'>	
                  ...
                  <div className='space-y-0.5 '>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        ...
                        <span className='text-xl font-face-gsb font-semibold h-6 w-158 text-color10 text-end'>{planData[0]?.direct_total ? planData[0].direct_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-69 text-color10'>Indirect</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-154 text-color10 text-end'>{planData[0]?.indirect_total ? planData[0].indirect_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-91 text-color10'>Marketing</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-158 text-color10 text-end'>{planData[0]?.marketing_total ? planData[0].marketing_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-79 text-color10'>HR costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-141 text-color10 text-end'>{planData[0]?.HRcost_total ? planData[0].HRcost_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10  justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-99 text-color10'>Office cost</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-137 text-color10 text-end'>{planData[0]?.officeCost_total ? planData[0].officeCost_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10 justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-102 text-color10'>Sales costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-128 text-color10 text-end'>{planData[0]?.salesCosts_total ? planData[0].salesCosts_total.toLocaleString() : ''} KM</span>
                     </div>
                     <div className='flex w-1009 h-10  justify-between items-center'>
                        <span className='text-xl font-face-r font-normal  w-106 text-color10'>Other costs</span>
                        <span className='text-xl font-face-gsb font-semibold h-6 w-99 text-color10 text-end'>{planData[0]?.otherCosts_total ? planData[0].otherCosts_total.toLocaleString() : ''} KM</span>
                     </div>
                  </div>	    
               </div>
